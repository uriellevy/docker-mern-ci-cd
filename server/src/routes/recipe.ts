...
import { createRecipe, getAllRecipes, getRecipeById, editRecipeById, deleteRecipeById, toggleRecipeLike, getMyRecipes, getCuisineList, getLikedRecipes} from "../controllers/recipe";
...
router.get("/favorites", requireAuth, getLikedRecipes);
